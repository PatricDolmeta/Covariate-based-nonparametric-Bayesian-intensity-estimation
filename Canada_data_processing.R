...
for(aa in 2004:2025){
  ...
  for(day in 1:30){
    ...
    tryCatch({
      ...
      # transform the heat scale, so to match the colors to intensity 
...
########## most represented value in a set, solving draws by randomization  #############
...
############### definition of non-border pixels using covariate images ################
{
...
####################### SUBSETTING ON THE BASIS OF REGIONS #############################
...
## division of Canada into regions by means of contour lines extrapolated from images ###
{
  ...
  # determine regions by means of encoldes area  
